...
class RealtimeKitAgent:
    ...
    async def run(self) -> None:
        try:
            ...
            asyncio.create_task(self.avatar_to_rtc_audio()).add_done_callback(log_exception)
            asyncio.create_task(self.avatar_to_rtc_video()).add_done_callback(log_exception)
